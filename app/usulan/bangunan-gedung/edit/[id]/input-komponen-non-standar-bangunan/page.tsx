...
import { EditNonStandardBuildingProvider } from './BuildingContext';
import LeftPanelForm from './LeftPanelForm';
import RightPanel3D from './RightPanel3D';

export default function EditKomponenNonStandarPage() {
  return (
    <EditNonStandardBuildingProvider>
      <main className="flex flex-col lg:flex-row min-h-screen bg-gray-100">
        ...
        <div className="w-full lg:w-3/5 overflow-y-auto border-r border-gray-200 bg-white p-6">
          <div className="mb-6">
            <h1 className="text-xl font-bold text-gray-800">Edit Komponen Non Standar Bangunan</h1>
